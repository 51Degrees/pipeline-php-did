...
enum FodIdParseStatus: string
{
    ...
    /**
     * The header was read and named a type whose value the payload is too
     * short to hold, being {@see FodId::GUID_LENGTH} bytes after the header
     * for a Random identifier and {@see FodId::HASH_LENGTH} bytes for a
     * Probabilistic or HashedEmail one. A Reserved identifier takes whatever
